...
#ifndef _GIT_REBASE_DIALOG_H
#define _GIT_REBASE_DIALOG_H
...
void on_menu_git_rebase_skip (GtkAction *action, Git *plugin);
void on_menu_git_rebase_abort (GtkAction *action, Git *plugin);
