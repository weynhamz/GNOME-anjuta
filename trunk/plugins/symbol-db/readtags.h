/*
*   $Id: readtags.h 2606 2006-08-16 21:13:34Z naba $
*
...
/* 
*  The same as tagsOpen () but you can pass here a FILE* already opened.
*  fd won't be closed after operations.
*/
extern tagFile *tagsOpen_1 (const FILE *fd, tagFileInfo *const info);
