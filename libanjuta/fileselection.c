...
{
#if 0 // FIXME: Watch 'project_root_directory' in shell
...
GtkWidget *
create_fileselection_gui (FileSelData * fsd, GtkWindow *parent)
{
	...
	*/
	...
	//gtk_window_add_accel_group (GTK_WINDOW (fileselection_gui),
	//			    ->accel_group);
