...
static gint search_get_item_combo(GtkEditable *editable, StringMap *map);
static gint search_get_item_combo_name(gchar *name, StringMap *map);
...
static gint
search_get_item_combo(GtkEditable *editable, StringMap *map)
{
	gchar *s;
	gint item;
...
static gint
search_get_item_combo_name(gchar *name, StringMap *map)
{
