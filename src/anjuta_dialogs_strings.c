...
gchar *s = N_("Additional make options:");
gchar *s = N_("*");
gchar *s = N_("Make options");
gchar *s = N_("Autosave editor files before build starts");
gchar *s = N_("Others");
gchar *s = N_("Build");
gchar *s = N_("Edit syntax highlighting styles");
...
gchar *s = N_("*");
gchar *s = N_("Custom style");
gchar *s = N_("Note: If there is a project open, the preferences in this page (indentation preferences) are project preferences and will be loaded from and saved with the project. If there is no project open, they will be global preferences.");
gchar *s = N_("Indentation");
gchar *s = N_("Top:");
gchar *s = N_("Bottom:");
gchar *s = N_("Left:");
gchar *s = N_("Right:");
gchar *s = N_("Print margins");
...
gchar *s = N_("B5");
gchar *s = N_("B5-Japan");
gchar *s = N_("Half-Letter");
gchar *s = N_("Executive");
gchar *s = N_("Tabloid/Ledger");
gchar *s = N_("Monarch");
gchar *s = N_("SuperB");
gchar *s = N_("Envelope-Commercial");
gchar *s = N_("Envelope-Monarch");
gchar *s = N_("Envelope-DL");
gchar *s = N_("Envelope-C5");
gchar *s = N_("EuroPostcard");
...
gchar *s = N_("Command options");
gchar *s = N_("CVS");
gchar *s = N_("Terminal font:");
gchar *s = N_("Select by word characters:");
gchar *s = N_("Scroll buffer size:");
gchar *s = N_("Terminal type:");
gchar *s = N_("Scroll on key stroke");
gchar *s = N_("Scroll on output");
gchar *s = N_("Enable blinking cursor");
gchar *s = N_("Enable terminal bell");
gchar *s = N_("*");
gchar *s = N_("xterm");
gchar *s = N_("vt100");
gchar *s = N_("vt220");
