					...
					const GValue *value, gpointer user_data)
{
	...
	cg_plugin = ANJUTA_CLASS_GEN_PLUGIN (plugin);
...
{
	AnjutaClassGenPlugin *cg_plugin;
	cg_plugin = ANJUTA_CLASS_GEN_PLUGIN (obj);
	g_free (cg_plugin->top_dir);
...
{
	AnjutaClassGenPlugin *plugin = ANJUTA_CLASS_GEN_PLUGIN (obj);
...
iwizard_activate (IAnjutaWizard *wiz, GError **err)
{
	...
	cg_plugin = ANJUTA_CLASS_GEN_PLUGIN (wiz);
