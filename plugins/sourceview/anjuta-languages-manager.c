...
anjuta_get_languages_manager (void)
{
...
GtkSourceLanguage *
anjuta_languages_manager_get_language_from_id (GtkSourceLanguagesManager *lm,
					      const gchar               *lang_id)
{
...
tag_style_to_string (const GtkSourceTagStyle *style)
{
	...
	background = color_to_string (style->background);
	foreground = color_to_string (style->foreground);
...
void
anjuta_language_set_tag_style (GtkSourceLanguage       *language,
			      const gchar             *tag_id,
...
void 
anjuta_language_init_tag_styles (GtkSourceLanguage *language)
{
	GSList *l;
	GSList *tags;
...
const GSList*
anjuta_languages_manager_get_available_languages_sorted (GtkSourceLanguagesManager *lm)
{
	const GSList *languages;
