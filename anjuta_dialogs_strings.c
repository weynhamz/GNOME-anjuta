...
gchar *s = N_("Is the regular expression or simple string");
gchar *s = N_("Regular expression");
gchar *s = N_("Greedy matching");
gchar *s = N_("Give the search expression");
gchar *s = N_("*");
...
gchar *s = N_("The search target(s) where search will be performed");
gchar *s = N_("*");
gchar *s = N_("*");
gchar *s = N_("*");
